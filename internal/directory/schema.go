...
// The reference MySQL schema (see the internal spec): the columns the daemons read are
...
// column standing in for the reference PR_DISPLAY_TYPE_EX row in user_properties
...
// address_status packing (the reference directory schema): low nibble = user status,
