...
// SizeLimits is the operator-editable per-protocol request caps. Every field is a
// byte size except FreeBusyMaxTargets, which is a count. It is stored as a single
// row; each protocol daemon polls it and applies its own field without a restart.
// It grows a field per protocol as each daemon is wired.
type SizeLimits struct {
	...
	// FreeBusyMaxTargets bounds how many mailboxes one availability request may fan
