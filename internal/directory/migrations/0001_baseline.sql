-- Directory baseline (see the internal spec): the account/domain directory. The
...
-- object of policy field to value, keyed by organization (the single global row is
...
-- domains table up to date. A no-op once applied.
