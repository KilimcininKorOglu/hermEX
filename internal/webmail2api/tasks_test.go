...
func TestTaskRichFieldsRoundTrip(t *testing.T) {
	...
	body := `{"summary":"Ship report","description":"Q3 numbers","start":"2026-07-01","due":"2026-07-15","priority":2,"reminder":true,"categories":["Urgent","Finance"]}`
