...
// TestApplyPOP3SizeLimit proves the command-line cap is applied only when a stored
...
func TestApplyPOP3SizeLimit(t *testing.T) {
	const sentinel int64 = -1

	// A clean read applies the stored cap verbatim.
	got := sentinel
	applyPOP3SizeLimit(nil,
		func() (directory.SizeLimits, bool, error) {
			return directory.SizeLimits{POP3CommandLineBytes: 4096}, true, nil
		},
		func(n int64) { got = n })
	if got != 4096 {
...
// TestApplyPOP3SizeLimitRecordsAReadFailure proves this daemon-local applier records
...
func TestApplyPOP3SizeLimitRecordsAReadFailure(t *testing.T) {
	sink := &captureSink{}
	applyPOP3SizeLimit(logging.New(sink),
		func() (directory.SizeLimits, bool, error) {
			return directory.SizeLimits{}, false, errors.New("db down")
		},
		func(int64) {})
	...
	quiet := &captureSink{}
	applyPOP3SizeLimit(logging.New(quiet),
		func() (directory.SizeLimits, bool, error) {
			return directory.SizeLimits{POP3CommandLineBytes: 4096}, true, nil
		},
		func(int64) {})
