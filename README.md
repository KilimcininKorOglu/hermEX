...
| Mail flow         | `internal/mta` (delivery), `internal/relay` + `internal/spooler` (outbound), `internal/meeting`, `internal/itip` (iMIP scheduling mail), `internal/fetchmail`, `internal/mailreport` (inbound DMARC and TLS report parser)                           |
